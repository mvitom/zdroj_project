...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.get_button_ch1 = customtkinter.CTkButton(self,text="GET",width=100,command=self.get_ch1)
        ...
        self.get_button_ch2 = customtkinter.CTkButton(self,text="GET",command=self.get_ch2,width=100)
        ...
        self.get_button_ch3 = customtkinter.CTkButton(self,text="GET",command=self.get_ch3,width=100)
